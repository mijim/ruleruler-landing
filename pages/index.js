...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>RULERULER</title>
        <link rel="icon" href="/favicon.ico" />
        <meta charset="UTF-8" />
        <meta
          name="description"
          content="RULERULER is a Chrome extension that allows you to quickly view all box sizes & font styles easily without having to open the inspector."
        />
        <meta name="keywords" content="Design, tool, web." />
        <meta name="author" content="Miguel Jiménez Benajes"></meta>
        <meta property="og:title" content="RULERULER | Chrome extension" />
        <meta
          property="og:description"
          content="RULERULER is a Chrome extension that allows you to quickly view all box sizes & font styles easily without having to open the inspector."
        />
        <meta property="og:image" content="/share.png" />
        <meta property="og:url" content="https://ruleruler.design"></meta>
      </Head>
      <body
        style={{
          margin: 0,
